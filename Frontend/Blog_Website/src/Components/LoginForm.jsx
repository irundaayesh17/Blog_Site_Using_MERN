...
export default function LoginForm() {
  return (
    <div className='shadow-md p-20'>
        ...
        <div className='mt-8'>
            <div>
                <label for='email' className='block text-lg font-medium'>Email</label>
            ...
            <div className='mt-4 flex justify-between items-center'>
                ...
                <button className='font-medium text-base text-blue-primary'>Fotgot Password</button>
            </div>
            <div className='mt-8 flex flex-col'>
                <button className='bg-blue-primary text-white text-lg font-bold py-3 rounded-3xl active:scale-[.99] active:duration-100 transition-all'> Sign in</button>
